...
/**
 * This object provides the basic file managing operations for an Android device.
 * 
...
public class AndroidFileProvider implements LocalFileService {
	...
	/**
	 * This variable indicates if the component is working or not. (Basically for the "getDirectorySizeAndroid" method)
	 */
	...
	/**
	 * Executes the given file into the Android device.
	 * 
	 * @param File
	 *            The given file.
	 */
	...
	/**
	 * Returns the base directories of the Android such as DCIM, Music, Downloads, etc.
	 */
	@Override
